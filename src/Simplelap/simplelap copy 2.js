...
(async () => {
    ...
    try {
        ...
        for (const GetLocation of GroupByClients) {
            ...
            const patients = await Patient.find({ status: 'Pending', Client: facilityName });
                        ...
                        if (collectionDate.includes(patient.dos)) {
                            ...
                            if (viewFileBtn) {
                                ...
                                if (match) {
                                    ...
                                    const pdfUrl = `https://www30.pointclickcare.com/clinical/lab/popup/viewReport.xhtml?fileId=${fileId}`;
